...
interface ILinearCurve {
    ...
    function getPrice(uint256 currentSupply, uint256 newSupply) external view returns (uint256);
    ...
    function getCurrentPrice(uint256 currentSupply) external view returns (uint256 price);
}
